...
public class AlarmReminderProvider extends ContentProvider {
    ...
    String sortOrder) {
        ...
        switch (match) {
            ...
            case REMINDER_ID:
                ...
                break;
            default:
                throw new IllegalArgumentException("Nie można wyszukać nieznanego URI " + uri);
        }
    ...
    public String getType(@NonNull Uri uri) {
        ...
        switch (match) {
            ...
            default:
                throw new IllegalStateException("Nieznane URI " + uri + " z match " + match);
        }
    }
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues contentValues) {
        ...
        switch (match) {
            ...
            default:
                throw new IllegalArgumentException("Wstawianie nie jest obsługiwane dla" + uri);
        }
    }
    ...
    private Uri insertReminder(Uri uri, ContentValues values) {
        ...
        if (id == -1) {
            Log.e(LOG_TAG, "Nie udało się wstawić wiersza dla" + uri);
            return null;
        }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            ...
            case REMINDER_ID:
                ...
                break;
            default:
                throw new IllegalArgumentException("Usuwanie nie jest obsługiwane w przypadku" + uri);
        }
        if (rowsDeleted != 0) {
            getContext().getContentResolver().notifyChange(uri, null);
        }
    ...
    public int update(Uri uri, ContentValues contentValues, String selection,
        ...
        switch (match) {
            ...
            case REMINDER_ID:
                ...
                return updateReminder(uri, contentValues, selection, selectionArgs);
            default:
                throw new IllegalArgumentException("Aktualizacja nie jest obsługiwana dla " + uri);
        }
    }
