...
public class AlarmReminderContract {
    ...
    public static final class AlarmReminderEntry implements BaseColumns {
        ...
        public static final String KEY_REPEAT = "powtórzenie";
        public static final String KEY_REPEAT_NO = "okres_powtótzenia";
        public static final String KEY_REPEAT_TYPE = "typ_powtórzenia";
        public static final String KEY_ACTIVE = "aktywność";
    }
