...
public class AddReminderActivity extends AppCompatActivity implements
    ...
    public void onSwitchRepeat(View view) {
        ...
        if (on) {
            mRepeat = "true";
            mRepeatText.setText("Co każdy " + mRepeatNo + " " + mRepeatType + "(s)");
        } else {
            mRepeat = "false";
    ...
    public void selectRepeatType(View v){
        ...
        builder.setTitle("Wybierz rodzaj");
        ...
        switch (item.getItemId()) {
            case R.id.save_reminder:
                if (mTitleText.getText().toString().length() == 0){
                    mTitleText.setError("Przypomnienie Tytuł nie może być pusty!");
                }
                else {
                    saveReminder();
                    finish();
    ...
    public void saveReminder(){
        ...
        if (mRepeatType.equals("Minuta")) {
            mRepeatTime = Integer.parseInt(mRepeatNo) * milMinute;
        } else if (mRepeatType.equals("Godzina")) {
            mRepeatTime = Integer.parseInt(mRepeatNo) * milHour;
        } else if (mRepeatType.equals("Dzień")) {
            mRepeatTime = Integer.parseInt(mRepeatNo) * milDay;
        } else if (mRepeatType.equals("Tydzień")) {
            mRepeatTime = Integer.parseInt(mRepeatNo) * milWeek;
        } else if (mRepeatType.equals("Miesiąc")) {
        ...
        if (mActive.equals("true")) {
            ...
            Toast.makeText(this, "Czas alarmu jest " + selectedTimestamp,
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            mRepeatText.setText("Co każdy " + repeatNo + " " + repeatType + "(s)");
